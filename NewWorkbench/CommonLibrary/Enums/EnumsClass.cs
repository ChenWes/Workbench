...
namespace NewWorkbench.CommonLibrary.Enums
{
    /// <summary>
    /// 枚举独特类
    ...
    public class ClsDic
    {
        ...
        public static Dictionary<string, string> DicAttachmentPath
        {
            get
            {
                ...
                _dic.Add("上传路径", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));// System.Configuration.ConfigurationManager.AppSettings["upfile"]);
                _dic.Add("档案简历",CommonLibrary.ConfigHelper.GetAppSettings("upfile"));// System.Configuration.ConfigurationManager.AppSettings["upfile"]);
                _dic.Add("手机文件", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["upphone"]);
                _dic.Add("手机照片", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["photofile"]);
                _dic.Add("技术文件", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["upTsfile"]);
                _dic.Add("工程图", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["UploadFiles"]);
                _dic.Add("档案头像", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["upfile"]);
        ...
        public static Dictionary<string, string> DicPhone
        {
            ...
            {
                Dictionary<string, string> _dic = new Dictionary<string, string>();
                _dic.Add("安卓程序", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["AndroidName"]);
                _dic.Add("苹果程序", CommonLibrary.ConfigHelper.GetAppSettings("upfile"));//System.Configuration.ConfigurationManager.AppSettings["IOSName"]);
                return _dic;
            }
        }
        /// <summary>
