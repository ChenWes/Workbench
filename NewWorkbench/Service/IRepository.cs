...
namespace NewWorkbench.Service
{
    ...
    public interface IRepository<T> where T : class
    {
        ...
        /// 数据上下文
        /// </summary>
        Domain.domainConfig Config { get; }
        ...
        CommonLibrary.PageInfo<T> Query(IQueryable<T> query, int index, int PageSize);
        ...
        /// <returns>结果集</returns>
        CommonLibrary.PageInfo Query(int index, int pageSize, string tableName, string field, string filter, string orderby, string group, params DbParameter[] para);
        ...
        /// <param name="sql"></param>
        /// <returns></returns>
        CommonLibrary.PageInfo Query(int index, int pageSize, string sql, string orderby, params DbParameter[] para);
